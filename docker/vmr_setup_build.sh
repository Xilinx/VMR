...
#TA=$(jq -r '.CONF_BUILD_TA' build.json)
...
sudo dpkg -i /proj/xbuilds/${TA}/xbb/packages/internal_platforms/vck5000/gen4x8_qdma/1-202210-1-dev/xilinx-vck5000-*_all.deb
