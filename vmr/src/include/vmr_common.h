...
#define VMR_EP_UCS_CONTROL 	XPAR_BLP_BLP_LOGIC_ULP_CLOCKING_UCS_CONTROL_STATUS_GPIO_UCS_CONTROL_STATUS_BASEADDR + VMR_EP_UCS_CHANNEL_2 
...
#define VMR_EP_RPU_SQ_BASE (XPAR_BLP_BLP_LOGIC_XGQ_M2R_BASEADDR + XGQ_SQ_TAIL_POINTER)
#define VMR_EP_RPU_CQ_BASE (XPAR_BLP_BLP_LOGIC_XGQ_M2R_BASEADDR + XGQ_CQ_TAIL_POINTER)

#define VMR_EP_APU_SHARED_MEMORY_START (0x37000000)
#define VMR_EP_APU_SHARED_MEMORY_END 	(0x37FF0000)

#define VMR_EP_APU_SQ_BASE (XPAR_BLP_BLP_LOGIC_XGQ_R2A_BASEADDR + XGQ_SQ_TAIL_POINTER)
#define VMR_EP_APU_CQ_BASE (XPAR_BLP_BLP_LOGIC_XGQ_R2A_BASEADDR + XGQ_CQ_TAIL_POINTER)
